...
import { HexagonHeader, puckComponentsRender, HexagonSectorDetail } from './HexagonComponents';
...
export default function App() {
  ...
  const puckConfig = {
    components: {
      ...
      NewsGrid: { render: puckComponentsRender.NewsGrid },
    ...
    return (
      <div className="w-full min-h-screen bg-white text-slate-800 flex flex-col font-sans">
        <div className="w-full bg-emerald-900 text-white py-2 px-8 text-xs font-bold flex justify-between items-center select-none z-50">
          <span>Chế độ Xem Trước Client (Đang xem slug: /{previewSlug})</span>
